  ...
  const [ thirdWebTokens, setThirdWebTokens ] = useState([]);
    ...
    useEffect(()=> {
        const getSanityAndThirdWebTokens = async () => {
            const coins = await fetch("https://pg32xg1p.api.sanity.io/v2021-03-25/data/query/production?query=*%5B_type%3D%3D'coins'%5D%7B%0A%20%20name%2C%0A%20%20contractAddress%2C%0A%20%20usdPrice%2C%0A%20%20symbol%2C%0A%20%20logo%0A%7D")
